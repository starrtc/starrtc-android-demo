package com.starrtc.staravdemo.demo.database;

import android.database.Cursor;

import com.starrtc.staravdemo.demo.MLOC;
import com.starrtc.staravdemo.utils.AEvent;
import com.starrtc.staravdemo.utils.CoreDBManager;
...
public class CoreDB implements IEventListener {
    ...
    public List<HistoryBean> getHistory(String type){
        Cursor cursor = coreDBM.rawQuery("select * from "+HISTORY_TABLE+" where type=?",new String[]{type});
